...
You can remove the tests when you know your functions work.
...
10.
To make this calculator more helpful, add the hours the user is over or under their ideal sleep time in each log statement in calculateSleepDebt().
